...
class DependencyContainer {
    ...
    private let logger = Logger(subsystem: AppConstants.loggingSubsystem, category: "DependencyContainer")
...
class UserDefaultsStorageService: StorageServiceProtocol {
    ...
    private let logger = Logger(subsystem: AppConstants.loggingSubsystem, category: "UserDefaultsStorage")
