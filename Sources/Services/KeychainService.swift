...
public final class KeychainService: @unchecked Sendable, KeychainServiceProtocol {
  ...
  public func retrieveEmailPassword(email: String, server: String, port: Int) -> Result<
  ...
  public func deleteEmailCredentials(email: String, server: String, port: Int) -> Result<
    Void, KeychainError
  > {
    let query: [String: Any] = [
      kSecClass as String: kSecClassInternetPassword,
