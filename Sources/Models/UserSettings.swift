...
struct UserSettings: Codable, Equatable {
    ...
    var currentPassword: String {
        // Use imapPassword for both Gmail and regular IMAP accounts
        // The test button works with imapPassword, so use the same for reservations
        return imapPassword
    }
    ...
    private var englishLocalizations: [String: String] {
        [
            ...
            "Test email and fetch latest email": "Test email and fetch latest email",
            "Testing email connection...": "Testing email connection...",
            "Opens Google's guide to creating app passwords": "Opens Google's guide to creating app passwords",
            ...
            "Server address is empty": "Server address is empty",
            "Connection successful": "Connection successful",
            "Connection failed": "Connection failed",
            "No verification codes found": "No verification codes found",
            "Verification codes found": "Verification codes found",
            ...
            "Send a test message to verify Telegram": "Send a test message to verify Telegram",
            ...
            "Reservation timed out after 5 minutes": "Reservation timed out after 5 minutes",
            ...
            "Security verification (reCAPTCHA) handling failed": "Security verification (reCAPTCHA) handling failed",
    ...
    private var frenchLocalizations: [String: String] {
        [
            ...
            "Test Email": "Tester le courriel",
            "Test email and fetch latest email": "Tester le courriel et récupérer le dernier email",
            "Testing email connection...": "Test de connexion courriel...",
            "Opens Google's guide to creating app passwords": "Ouvre le guide Google pour créer un mot de passe d'application",
            "Test message sent successfully!": "Message de test envoyé avec succès !",
            "Failed to send test message": "Échec de l'envoi du message de test",
            ...
            "Server address is empty": "L'adresse du serveur est vide",
            "Connection successful": "Connexion réussie",
            "Connection failed": "Connexion échouée",
            "No verification codes found": "Aucun code de vérification trouvé",
            "Verification codes found": "Codes de vérification trouvés",
            ...
            "Test Telegram": "Tester Telegram",
            "Send a test message to verify Telegram": "Envoyer un message de test pour vérifier Telegram",
            ...
            "Reservation timed out after 5 minutes": "La réservation a expiré après 5 minutes",
            ...
            "Email verification failed": "La vérification par courriel a échoué",
            "Security verification (reCAPTCHA) handling failed": "La gestion de la vérification de sécurité (reCAPTCHA) a échoué",
            ...
            "Add Time Slot (max 2)": "Ajouter l'heure",
            "Mon": "Lun",
            "Tue": "Mar",
            "Wed": "Mer",
            "Thu": "Jeu",
